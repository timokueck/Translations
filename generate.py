...
languages = ["German", "French", "Italian", "Spanish", "Hebrew", "Dutch", "Turkish", "Portuguese", "Czech"]; # Exclude English because thats the default language
...
if len(templateFiles) == 0:
    print("Please add templates into the templates folder");
    exit();
...
for templateFile in templateFiles:
    ...
    templateReader = open("templates/"+templateFile, "r");
    templateLines = templateReader.readlines();
    templateReader.close();

    for language in languages:
        fileName = "translations/"+templateName+"_"+language+".lang";
